...
namespace WindowsFormsApplication1
{
    public class Controller
    {
        ...
        public void SetStart(object sender, DataGridView dataView)
        {
        ...
        public void SetEnd(object sender)
        {
        ...
        public void printPath(RichTextBox debugLog, int start, int finish, int[] path)
        {
        ...
        public void outputLog(RichTextBox debugLog, string text)
        {
            debugLog.AppendText("\r\n" + text);
            debugLog.ScrollToCaret();
        }

        public void drawNodes(bool drawLine)
        {
        ...
        public void OneClick(object sender, EventArgs e, RichTextBox debugLog)
        {
        ...
        public void TwoClick(object sender, EventArgs e, RichTextBox debugLog, DataGridView dataView)
        {
        ...
        public void showSimulatedDataTable(DataGridView dataView)
        {
        ...
        public void Dijkstra(object sender, EventArgs e, RichTextBox debugLog)
        {
        ...
        public void ValueChanged(object sender, DataGridViewCellEventArgs e, RichTextBox debugLog, DataGridView dataView)
        {
        ...
        public void colorNode(ColorDialog colorDialog)
        {
